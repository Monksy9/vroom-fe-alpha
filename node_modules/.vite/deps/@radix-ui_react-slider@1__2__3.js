...
import {
  createContextScope
} from "./chunk-LQMYIA2Y.js";
import {
  Primitive
} from "./chunk-DATWSZVZ.js";
import {
  createSlot,
  useComposedRefs
...
var Slider = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React8.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React8.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React8.useRef(values);
    ...
    return (0, import_jsx_runtime4.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime4.jsx)(Collection.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime4.jsx)(Collection.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime4.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React8.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React8.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React8.useRef(void 0);
...
var SliderVertical = React8.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const sliderRef = React8.useRef(null);
...
var SliderImpl = React8.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React8.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React8.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React8.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection(props.__scopeSlider);
    const [thumb, setThumb] = React8.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React8.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime4.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index });
  }
);
var SliderThumbImpl = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime4.jsx)(Collection.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime4.jsx)(
            Primitive.span,
            {
              role: "slider",
...
var SliderBubbleInput = React8.forwardRef(
